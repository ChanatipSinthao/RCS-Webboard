  ...
  <section class="container forms">
    <div class="form login">
      <div class="form-content">
        <header class="header-btn">เข้าสู่ระบบ</header>
        <form action="/php/login.php" method="POST">
          <div class="field input-field">
            <input type="text" name="email" placeholder="อีเมล" class="input" required>
          </div>
        ...
        <div class="form-link">
          <span>คุณยังไม่ได้เป็นสมาชิก? <a href="/user/page/signup.php">สมัครที่นี่</a></span>
        </div>
      </div>
